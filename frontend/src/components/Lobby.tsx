    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4">
            <div className="glass-panel p-12 max-w-3xl w-full">
                <h2 className="text-4xl font-bold mb-4 text-center bg-gradient-to-r bg-clip-text text-transparent">
                    Game Lobby
                </h2>

                <div className="text-center mb-8">
                    <p className="text-white/60 mb-2">Room Code</p>
                    <div className="text-5xl font-bold tracking-widest text-white mb-2">
                        {room.code}
                    </div>
                    <button
                    ...
                    <div className="space-y-2">
                        {room.players.map((player) => (
                            ...
                            >
                                ...
                                <span className={player.isReady ? "text-green-400" : "text-white/50"}>
                        ...
                        {room.players.length < room.settings.maxPlayers && (
                            <div className="glass-panel p-4 text-center text-white/50">
                ...
                <div className="mb-6">
                    <h3 className="text-xl font-bold mb-3 text-white">Game Settings</h3>
                    <div className="glass-panel p-4 space-y-2 text-white/80">
