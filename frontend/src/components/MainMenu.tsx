                ...
                {view === 'select-game' ? (
                    ...
                    <div className="animate-fadeIn space-y-8">
                        <div className="text-center max-w-2xl mx-auto">
                            <div className="inline-block px-3.5 py-1.5 rounded-full bg-indigo-100 text-indigo-700 font-semibold text-xs sm:text-sm mb-4 shadow-xs border border-indigo-200">
                                🎮 Arcade Games Hub
                            </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
                            ...
                            >
                                <div>
                                    <div className="flex items-center justify-between mb-6">
                                        <div className="w-16 h-16 rounded-2xl bg-gradient-to-tr from-blue-500 to-indigo-600 text-white flex items-center justify-center text-3xl shadow-lg shadow-indigo-500/30 group-hover:scale-110 transition-transform duration-300">
                                            💥
                                        </div>
                            ...
                            >
                                <div>
                                    <div className="flex items-center justify-between mb-6">
                                        <div className="w-16 h-16 rounded-2xl bg-gradient-to-tr from-purple-500 to-pink-500 text-white flex items-center justify-center text-3xl shadow-lg shadow-purple-500/30 group-hover:scale-110 transition-transform duration-300">
                                            ❌⭕
                                        </div>
                    ...
                    <div className="animate-fadeIn space-y-6 max-w-md mx-auto">
                        ...
                        <div className="bg-white/80 backdrop-blur-xl p-6 sm:p-8 rounded-3xl border border-white shadow-2xl shadow-slate-200/60 text-center">
                            <div className="w-20 h-20 rounded-3xl bg-indigo-50 border border-indigo-100 flex items-center justify-center text-4xl mx-auto mb-4 shadow-sm">
                                {getGameIcon()}
                            </div>
                            ...
                            <div className="space-y-4">
                                ...
                                >
                                    <div className="w-12 h-12 rounded-xl bg-indigo-50 flex items-center justify-center text-xl shrink-0">
                                        🔗
                                    </div>
                                    <div className="ml-4 flex-1">
